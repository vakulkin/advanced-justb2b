 ...
 * @title[ru] Управление ценовыми правилами
 * @title[pl] Zarządzanie regułami cenowymi
 * @desc[ru] Вы можете легко создавать и редактировать правила, которые автоматически изменяют цену в зависимости от роли клиента, количества, категории и других условий.
 * @desc[pl] Możesz łatwo tworzyć i edytować reguły, które automatycznie zmieniają cenę w zależności od roli klienta, ilości, kategorii i innych warunków.
 * @order 200
 */
 ...
 * @title[pl] Wszystko pod kontrolą — w jednym miejscu
 * @desc[ru] Все ценовые правила собраны в удобной таблице в админке.
 * @desc[pl] Wszystkie reguły cenowe są zebrane w przejrzystej tabeli w panelu administracyjnym.
 * @order 201
 */
